      ...
      -- Snippet Engine & its associated nvim-cmp source
      {
        ...
        dependencies = {
          ...
          --    https://github.com/rafamadriz/friendly-snippets
          {
            ...
            config = function()
              local fvscode = require 'luasnip.loaders.from_vscode'
              fvscode.lazy_load()
              fvscode.load { paths = { os.getenv 'HOME' .. '/dotfiles/snippets' } }
            end,
          },
        },
      },
...
vim.api.nvim_create_augroup('CHeaderMapping', { clear = true })
vim.api.nvim_create_autocmd({ 'BufRead', 'BufNewFile' }, {
  pattern = { '*.h', '*.hpp', '*.cpp', '*.cxx', 'CMakeLists.txt' },
  callback = function()
